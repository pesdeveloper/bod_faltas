...
/**
 * Test de seguridad para POST /api/faltas/actas/{id}/firmeza/por-apelacion-rechazada.
 *
 * Verifica que:
 * - sin Bearer -> 401
...
@DisplayName("IT seguridad: POST actas/{id}/firmeza/por-apelacion-rechazada requiere Bearer JWT firmado")
class FirmezaApelacionRechazadaSecurityTest {

    @Autowired
    private MockMvc mockMvc;

    private static final String URL = "/api/faltas/actas/99/firmeza/por-apelacion-rechazada";
