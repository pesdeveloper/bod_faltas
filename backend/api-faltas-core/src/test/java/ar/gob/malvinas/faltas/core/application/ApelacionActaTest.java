...
class ApelacionActaTest {
    ...
    class RechazarApelacion {
        ...
        @Test
        @DisplayName("Rechazar apelacion: registra APERAZ, estado RECHAZADA, no cierra, snapshot DECLARAR_CONDENA_FIRME")
        void rechazar_apelacion_caso_feliz() {
            ...
            assertThat(apelOpt).isPresent();
            FalActaApelacion apelacion = apelOpt.get();
            assertThat(apelacion.getEstadoApelacion()).isEqualTo(EstadoApelacionActa.RECHAZADA);
