...
public class ObservacionService {
    ...
    public ObservacionService(ObservacionRepository repo, ActaRepository actaRepo,
        ...
        registrarValidador(EntidadTipoObservada.OBLIGACION_PAGO, id -> { /* validado externamente via ObligacionPagoService */ });
        registrarValidador(EntidadTipoObservada.FORMA_PAGO, id -> { /* validado externamente via FormaPagoService */ });
        registrarValidador(EntidadTipoObservada.PLAN_PAGO, id -> { /* validado externamente via PlanPagoService */ });
        registrarValidador(EntidadTipoObservada.MOVIMIENTO_PAGO, id -> { /* validado externamente via PagoMovimientoService */ });
    }
