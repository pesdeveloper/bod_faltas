...
> seguir. Ver [`../00-governance/ready-for-ddl-gate.md`](../00-governance/ready-for-ddl-gate.md),
> [`jdbc-infrastructure.md`](jdbc-infrastructure.md), [`inmemory-mariadb-deltas.md`](inmemory-mariadb-deltas.md)
> y [`mariadb-logical-model.md`](mariadb-logical-model.md).
...
[`jdbc-infrastructure.md`](jdbc-infrastructure.md).
...
en [`mariadb-logical-model.md`](mariadb-logical-model.md). Este documento no repite
esa tabla.
...
- No usar `UUID`/`String` como PK interna salvo caso excepcional explicitamente justificado
  (ver decisiones abiertas en [`ddl-decisions.md`](ddl-decisions.md), seccion `DECISION_DDL-PAGO-01` y relacionadas).

## 6. Estrategia de enums persistibles

No todo enum de dominio expone un codigo explicito. Se distinguen tres categorias
(ver [`inmemory-mariadb-deltas.md`](inmemory-mariadb-deltas.md) y [`ddl-decisions.md`](ddl-decisions.md), `DECISION_DDL-ENUM-01`):
...
bloqueo) se rige por [`inmemory-mariadb-deltas.md`](inmemory-mariadb-deltas.md) y por las decisiones fisicas
de [`ddl-decisions.md`](ddl-decisions.md); este documento no repite esa matriz.
