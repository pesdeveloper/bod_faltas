...
ver `../20-application/command-contracts.md`, seccion "Cierre diferido en CumplirBloqueante y
AnularBloqueante").
...
- Notificar un pago contra una obligacion no vigente (evento `PAGANT`) y
  ...
  del acta; ver `../10-domain/states-events-catalogs.md` (seccion "Pago aplicado a
  obligacion anterior: PAGANT y PAGRES") y
  `../20-application/command-contracts.md` (seccion "Pago aplicado a
