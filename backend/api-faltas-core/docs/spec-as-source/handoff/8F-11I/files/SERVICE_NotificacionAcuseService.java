...
public class NotificacionAcuseService {
    ...
    public FalNotificacionAcuse registrarAcuse(
        ...
        if (acta != null) {
            registrarEvento(acta.getId(), TipoEventoActa.ACUGEN,
                    String.valueOf(notificacionId), String.valueOf(acuse.getId()), idUser,
        ...
        if (notif != null) {
            ...
            if (acta != null) {
                registrarEvento(acta.getId(), TipoEventoActa.ACUVAL,
                        String.valueOf(acuse.getNotificacionId()), String.valueOf(acuseId), idUser,
    ...
    private void registrarEvento(Long idActa, TipoEventoActa tipo, String idNotif, String idAcuse, String idUser, String descripcion) {
