...
public class LoteCorreoService {
    ...
    public FalLoteCorreo generarLoteConIntentos(
        ...
        for (Long actaId : actasAfectadas) {
            ...
            if (acta != null) {
                registrarEvento(actaId, TipoEventoActa.LOTGEN, String.valueOf(loteId), null, idUser,
    ...
    private void registrarEvento(Long idActa, TipoEventoActa tipo, String idRef, String idExtra, String idUser, String descripcion) {
        ...
        FalActaEvento evento = new FalActaEvento(UUID.randomUUID().toString(), idActa, tipo,
                LocalDateTime.now(), orden, null, idRef, idUser != null ? idUser : "SYS", descripcion, null);
