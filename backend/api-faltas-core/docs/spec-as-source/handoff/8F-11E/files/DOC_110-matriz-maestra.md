...
| FALTA_EN_MARIADB | 0 |
| **ALINEADO** | **41 tablas** |
| **FALTA_EN_INMEMORY** | **12 tablas** (canonicas - ver seccion 11.7) |
| FALTA_EN_MARIADB | 0 |
| IDENTIDAD_INCOMPATIBLE | 0 (5 resueltas en 8F-11B) |
| TIPO_INCOMPATIBLE | 0 (3 resueltos en 8F-11B) |
| **PARCIAL** | **4 tablas** (fal_acta, fal_acta_evento, fal_acta_fallo, fal_acta_apelacion) |
