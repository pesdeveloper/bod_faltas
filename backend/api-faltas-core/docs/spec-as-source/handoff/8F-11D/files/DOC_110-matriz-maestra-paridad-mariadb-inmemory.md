...
**Slice:** 8F-11A + 8F-11A-R1 (corrección documental)  
**Fecha:** 2026-07-04 (8F-11A) / 2026-07-05 (8F-11A-R1, 8F-11B, 8F-11C)  
**Tipo:** Auditoría y documentación exhaustiva. Sin cambios funcionales Java.  
**Módulo:** backend/api-faltas-core  
**Build base:** 1660 tests, 0 failures, 0 errors, BUILD SUCCESS (verificado en 8F-11C)  
**Fuente vigente:** este documento reemplaza a 109 como matriz de paridad activa. El 109 queda como historial de auditoría de 8F-9/8F-10. Corregido en 8F-11A-R1: conteos (62/29 INMEMORY). 8F-11B cerrado: identidades, enums, versionRow. 8F-11C cerrado: FalPersona+FalPersonaDomicilio ALINEADOS (27 FALTA_EN_INMEMORY), P1 cerrada (SMALLINT 0-4), P2 cerrada (firmeza en fallo), catálogos, roadmap.
...
| ALINEADO | 26 entidades |
| FALTA_EN_INMEMORY | 29 tablas sin entidad |
| FALTA_EN_MARIADB | 0 |
...
| RELACION_INCOMPLETA | 3 relaciones |
| NULABILIDAD_INCOMPATIBLE | 1 |
...
- **Estado InMemory:** PARCIAL — gaps: tipoActa String, resultadoFinal tipo, datos persona embebidos, sin auditoría
...
- **Entidad Java:** FalActaEvento ✓ (record), id String — **Estado:** PARCIAL
...
- **Estado InMemory:** FALTA_EN_INMEMORY — PAGAPR usa evento.descripcion transitoriamente — GAP-11, Slice 8F-11G
...
- **Entidad Java:** NO EXISTE
- **Estado InMemory:** FALTA_EN_INMEMORY — GAP-7, Slice 8F-11D

#### `fal_medida_preventiva`
- **Entidad Java:** NO EXISTE — **Estado:** FALTA_EN_INMEMORY, Slice 8F-11D
...
- **Entidad Java:** NO EXISTE — placeholder en FalActaFallo.montoCondena
- **Estado InMemory:** FALTA_EN_INMEMORY — GAP-7, Slice 8F-11D

#### `fal_acta_valorizacion_item`
- **PK:** id BIGINT AUTO_INCREMENT
- **FK:** id_valorizacion → fal_acta_valorizacion, id_articulo → fal_articulo_normativa_faltas
- **Entidad Java:** NO EXISTE — **Estado:** FALTA_EN_INMEMORY, Slice 8F-11D
...
- **Entidad Java:** NO EXISTE — **Estado:** FALTA_EN_INMEMORY, Slice 8F-11E
...
- **Entidad Java:** NO EXISTE — **Estado:** FALTA_EN_INMEMORY, Slice 8F-11I
...
- **Estado InMemory:** FALTA_EN_INMEMORY — D3 cerrada: implementar InMemory antes de JDBC — GAP-4, Slice 8F-11G
...
- **Estado InMemory:** FALTA_EN_INMEMORY — GAP-5, Slice 8F-11G
...
- **Auditoría:** fh_alta, id_user_alta, fh_mod, id_user_mod
- **Entidad Java:** FalPagoVoluntario (tipo=1) y FalPagoCondena (tipo=2) — id String
- **Estado InMemory:** SEMANTICA_INCOMPATIBLE (D2 cerrada) — dos clases separadas vs tabla única — Slice 8F-11H

#### `fal_acta_forma_pago`
- **Entidad Java:** NO EXISTE — **Estado:** FALTA_EN_INMEMORY, Slice 8F-11H
...
- **Entidad Java:** NO EXISTE
- **Estado InMemory:** FALTA_EN_INMEMORY — DIFERIBLE (baja prioridad) — Slice 8F-11K
...
|---|---|---|---|---|
| `FalActa` | `fal_acta` | Long ✓ | BIGINT ✓ | PARCIAL (tipo_acta String, persona embebida, sin auditoría) |
...
|---|---|---|
| `fal_vehiculo_marca` | Catálogo de vehículos — tránsito | FALTA_EN_INMEMORY — Slice 8F-11E |
| `fal_vehiculo_modelo` | Catálogo de vehículos — tránsito | FALTA_EN_INMEMORY — Slice 8F-11E |
| `fal_rubro_version` | Catálogo rubros versionado — contravención | FALTA_EN_INMEMORY — Slice 8F-11E |
...
### 11.7 Las 29 tablas FALTA_EN_INMEMORY — listado explícito

Ninguna de estas 29 tablas debe clasificarse como NO_PERSISTIBLE, diferible sin implementación, o excluida del objetivo de paridad.

**Personas y observaciones (3):**
1. `fal_persona`
2. `fal_persona_domicilio`
3. `fal_observacion`

**Normativa, medidas y valorización (6):**
4. al_tarifario_unidad_faltas — **ALINEADO (8F-11D)**
5. al_medida_preventiva — **ALINEADO (8F-11D)**
6. al_articulo_medida_preventiva — **ALINEADO (8F-11D)**
7. al_acta_articulo_infringido — **ALINEADO (8F-11D)**
8. al_acta_valorizacion — **ALINEADO (8F-11D)**
9. al_acta_valorizacion_item — **ALINEADO (8F-11D)**

**Satélites del acta (6):**
10. `fal_acta_transito`
11. `fal_acta_transito_alcoholemia`
12. `fal_acta_vehiculo`
13. `fal_acta_contravencion`
14. `fal_acta_sustancias_alimenticias`
15. `fal_acta_medida_preventiva`

**Ciclo de notificación (3):**
16. `fal_notificacion_intento`
17. `fal_notificacion_acuse`
18. `fal_lote_correo`

**Apelación, paralización y archivo (3):**
19. `fal_acta_apelacion_documento`
20. `fal_acta_paralizacion`
21. `fal_acta_archivo`

**Pagos (3):**
22. `fal_acta_forma_pago`
23. `fal_acta_plan_pago_ref`
24. `fal_acta_pago_movimiento`

**Portal (1):**
25. `fal_acta_qr_acceso`

**Catálogos del dominio (4):**
26. `fal_vehiculo_marca`
27. `fal_vehiculo_modelo`
28. `fal_rubro_version`
29. `fal_motivo_archivo`
...
### Tablas alineadas (6)
1. al_tarifario_unidad_faltas → FalTarifarioUnidadFaltas
2. al_medida_preventiva → FalMedidaPreventiva
3. al_articulo_medida_preventiva → FalArticuloMedidaPreventiva (PK compuesta via ArticuloMedidaPreventivaId)
4. al_acta_articulo_infringido → FalActaArticuloInfringido
5. al_acta_valorizacion → FalActaValorizacion (versionRow, optimistic locking)
6. al_acta_valorizacion_item → FalActaValorizacionItem
...
### Conteo actualizado
- **27 → 21 tablas FALTA_EN_INMEMORY**
- Tests: 1660 → **1755**
