...
public class FalActaApelacion {
    ...
    /** @deprecated campo eliminado del modelo */
    @Deprecated public String getFundamentosResolucion() { return null; }
    /** @deprecated campo eliminado del modelo */
    @Deprecated public void setFundamentosResolucion(String f) { }
    /** @deprecated campo eliminado del modelo */
    @Deprecated public String getObservacionesResolucion() { return null; }
    /** @deprecated campo eliminado del modelo */
    @Deprecated public void setObservacionesResolucion(String o) { }
    /**
