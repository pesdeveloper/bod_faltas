...
public class QrActaService {
    ...
    private void registrarEvento(Long actaId, TipoEventoActa tipo, String idDoc, String idUser, String descripcion) {
        ...
        FalActaEvento evento = new FalActaEvento(
                ...
                LocalDateTime.now(), orden, idDoc, null,
                idUser != null ? idUser : "SYS", descripcion, null);
