...
| Campo nuevo | Tipo | Null | Descripción |
|---|---|---|---|
| `firma_storage_key` | `VARCHAR(255)` | SÍ | Firma registrada del inspector |
| `firma_hash` | `VARCHAR(128)` | SÍ | Hash de integridad de firma |
| `fh_firma_registrada` | `DATETIME(6)` | SÍ | Fecha de registro de firma |
...
| DDL `fal_inspector_version` | Agregar `firma_storage_key`, `firma_hash`, `fh_firma_registrada` (todos nullable). |
...
fal_inspector_version campos firma: firma_storage_key, firma_hash, fh_firma_registrada ausentes en Java.
