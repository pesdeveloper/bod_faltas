...
| `firma_storage_key` | `VARCHAR(255)` | SÍ | — | Firma registrada del inspector | Imagen/vector en storage |
| `firma_hash` | `VARCHAR(128)` | SÍ | — | Hash de integridad de firma | Opcional |
| `fh_firma_registrada` | `DATETIME(6)` | SÍ | — | Fecha de registro de firma | Auditoría funcional |
...
| `resultado_final` | `CHAR(6)` | SÍ | IDX | Resultado final | Resultado consolidado del expediente |
...
| `resultado_final` | `CHAR(6)` | SÍ | IDX | Resultado final | `fal_acta` |
...
- Debe existir una firma registrada en `fal_inspector_version.firma_storage_key`..
...
Regla: fallo absolutorio no genera monto de condena exigible.
